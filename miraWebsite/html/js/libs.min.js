$(".promo-slider__button").click(function () {
  $("html,body").animate(
    {
      scrollTop: $(".main-about_slide").offset().top,
    },
    "slow"
  );
});
...
!(function (t, e) {
  ...
  f(document).on(
    ...
    (f.fn[o] = m._jQueryInterface),
    (f.fn[o].Constructor = m),
    ...
    O = (function () {
      ...
      return (
        ...
        (i._jQueryInterface = function (e) {
          return this.each(function () {
            var t = f(this).data(y);
            t || ((t = new i(this)), f(this).data(y, t)),
              "toggle" === e && t[e]();
          });
        }),
        r(i, null, [
  ...
  f(document)
    .on(A.CLICK_DATA_API, C, function (t) {
      t.preventDefault();
      var e = t.target;
      f(e).hasClass(S) || (e = f(e).closest(I)),
        O._jQueryInterface.call(f(e), "toggle");
    })
    .on(A.FOCUS_BLUR_DATA_API, C, function (t) {
      var e = f(t.target).closest(I)[0];
      f(e).toggleClass(T, /^focus(in)?$/.test(t.type));
    }),
    (f.fn[v] = O._jQueryInterface),
    (f.fn[v].Constructor = O),
      ...
      return (
        ...
        (t._addTouchEventListeners = function () {
          ...
          if (this._touchSupported) {
            ...
            f(this._element.querySelectorAll(et)).on(
              q.DRAG_START,
              function (t) {
        ...
        (s._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (t || ((t = new s(this, e)), f(this).data(D, t)),
              "number" == typeof n)
            )
              t.to(n);
  ...
  f(document).on(q.CLICK_DATA_API, ot, at._dataApiClickHandler),
    ...
    (f.fn[P] = at._jQueryInterface),
    (f.fn[P].Constructor = at),
      ...
      return (
        ...
        (t.show = function () {
          ...
          if (
            ...
            !(
              t &&
              (e = f(t).not(this._selector).data(ct)) &&
              e._isTransitioning
            ))
          ) {
            ...
            if ((f(this._element).trigger(n), !n.isDefaultPrevented())) {
              t &&
                (a._jQueryInterface.call(f(t).not(this._selector), "hide"),
                e || f(t).data(ct, null));
              var o = this._getDimension();
              f(this._element).removeClass(mt).addClass(vt),
              ...
              f(this._element)
                .one(g.TRANSITION_END, function () {
                  f(i._element).removeClass(vt).addClass(mt).addClass(gt),
                    (i._element.style[o] = ""),
                    i.setTransitioning(!1),
                    f(i._element).trigger(ft.SHOWN);
                })
          ...
          if (!this._isTransitioning && f(this._element).hasClass(gt)) {
            ...
            if ((f(this._element).trigger(e), !e.isDefaultPrevented())) {
              ...
              (this._element.style[i] =
                ...
                f(this._element).addClass(vt).removeClass(mt).removeClass(gt);
                ...
                for (var o = 0; o < n; o++) {
                  ...
                  if (null !== r)
                    f([].slice.call(document.querySelectorAll(r))).hasClass(
                      gt
                    ) || f(s).addClass(yt).attr("aria-expanded", !1);
                }
              this.setTransitioning(!0);
              this._element.style[i] = "";
  ...
  f(document).on(ft.CLICK_DATA_API, xt, function (t) {
    ...
    (f.fn[lt] = St._jQueryInterface),
    (f.fn[lt].Constructor = St),
  ...
  function Ft(t, e) {
    ...
    if ((t !== l && e !== l) || n.contains(o))
      return "BODY" === (a = (r = l).nodeName) ||
        ("HTML" !== a && jt(r.firstElementChild) !== r)
        ? jt(l)
        : l;
    var c = zt(t);
      ...
      modifiers: {
        ...
        arrow: {
          ...
          fn: function (t, e) {
            ...
            return (
              (_ = Math.max(Math.min(r[c] - f, _), 0)),
              (t.arrowElement = n),
              (t.offsets.arrow =
                (Ut((i = {}), d, Math.round(_)), Ut(i, u, ""), i)),
              t
            );
          },
          element: "[x-arrow]",
            ...
            return (
              b.forEach(function (t, e) {
                ...
                (r || d || p) &&
                  ...
                  p &&
                    (_ =
                      "end" === (i = _) ? "start" : "start" === i ? "end" : i),
                  (f.placement = v + (_ ? "-" + _ : "")),
                  (f.offsets.popper = Qt(
                    {},
                    f.offsets.popper,
                    ie(f.instance.popper, f.offsets.reference, f.placement)
                  )),
                  (f = oe(f.instance.modifiers, f, "flip")));
              }),
              f
            );
          },
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            return (
              (t.attributes = Qt({}, y, t.attributes)),
  ...
  function Te(t, e) {
    ...
    !(function (t, e) {
      ...
      (this.options = Qt({}, Te.Defaults, n)),
      (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
      (this.reference = t && t.jquery ? t[0] : t),
      (this.popper = e && e.jquery ? e[0] : e),
      (this.options.modifiers = {}),
      Object.keys(Qt({}, Te.Defaults.modifiers, n.modifiers)).forEach(function (
        t
      ) {
        i.options.modifiers[t] = Qt(
          {},
          Te.Defaults.modifiers[t] || {},
  ...
  var Ce = "dropdown",
    ...
    Ze = (function () {
      ...
      return (
          ...
          if (!this._element.disabled && !f(this._element).hasClass(Pe)) {
            ...
            if ((c._clearMenus(), !e)) {
              ...
              if ((f(t).trigger(n), !n.isDefaultPrevented())) {
                ...
                "ontouchstart" in document.documentElement &&
                  0 === f(t).closest(We).length &&
                  f(document.body).children().on("mouseover", null, f.noop),
                  this._element.focus(),
                  this._element.setAttribute("aria-expanded", !0),
                  f(this._menu).toggleClass(De),
                  f(t).toggleClass(De).trigger(f.Event(Oe.SHOWN, i));
              }
            }
          }
        }),
        (t.show = function () {
          if (
            !(
              ...
              f(this._element).hasClass(Pe) ||
              f(this._menu).hasClass(De)
            )
          ) {
            ...
            f(i).trigger(e),
              e.isDefaultPrevented() ||
                (f(this._menu).toggleClass(De),
                f(i).toggleClass(De).trigger(f.Event(Oe.SHOWN, t)));
          }
        }),
        (t.hide = function () {
          if (
            ...
            f(i).trigger(e),
              e.isDefaultPrevented() ||
                (f(this._menu).toggleClass(De),
                f(i).toggleClass(De).trigger(f.Event(Oe.HIDDEN, t)));
          }
        }),
        (t.dispose = function () {
          f.removeData(this._element, ke),
        ...
        (t._getConfig = function (t) {
          return (
            (t = l({}, this.constructor.Default, f(this._element).data(), t)),
        ...
        (t._getPlacement = function () {
          ...
          return (
            t.hasClass(Me)
              ? ((e = Be), f(this._menu).hasClass(ze) && (e = Ue))
              : t.hasClass(Le)
              ? (e = Xe)
              : t.hasClass(je)
              ? (e = Ve)
              : f(this._menu).hasClass(ze) && (e = Ye),
            e
          );
        }),
        ...
        (c._clearMenus = function (t) {
          if (!t || (3 !== t.which && ("keyup" !== t.type || 9 === t.which)))
            for (
              var e = [].slice.call(document.querySelectorAll(He)),
                i = 0,
                n = e.length;
              i < n;
              i++
                ...
                if (
                  ...
                  f(o).trigger(l),
                    l.isDefaultPrevented() ||
                      ...
                      f(a).removeClass(De),
                      f(o).removeClass(De).trigger(f.Event(Oe.HIDDEN, r)));
                }
              }
            }
        }),
              ...
              ? !(
                  ...
                  (27 !== t.which &&
                    ((40 !== t.which && 38 !== t.which) ||
                      f(t.target).closest(Re).length))
                )
              : Ae.test(t.which)) &&
            (t.preventDefault(),
            t.stopPropagation(),
            !this.disabled && !f(this).hasClass(Pe))
          ) {
  ...
  f(document)
    .on(Oe.KEYDOWN_DATA_API, He, Ze._dataApiKeydownHandler)
    .on(Oe.KEYDOWN_DATA_API, Re, Ze._dataApiKeydownHandler)
    .on(Oe.CLICK_DATA_API + " " + Oe.KEYUP_DATA_API, Ze._clearMenus)
    .on(Oe.CLICK_DATA_API, He, function (t) {
      t.preventDefault(),
        t.stopPropagation(),
        Ze._jQueryInterface.call(f(this), "toggle");
    })
      ...
      return (
          ...
          if (!this._isShown && !this._isTransitioning) {
            ...
            f(this._element).trigger(i),
              this._isShown ||
                ...
                f(this._element).on(si.CLICK_DISMISS, gi, function (t) {
                  return e.hide(t);
                }),
        ...
        (t._showElement = function (t) {
          ...
          (this._element.parentNode &&
            ...
            f(this._dialog).hasClass(ri)
              ? (this._dialog.querySelector(pi).scrollTop = 0)
        ...
        (t._hideModal = function () {
          ...
          (this._element.style.display = "none"),
            ...
            (this._isTransitioning = !1),
            this._showBackdrop(function () {
              f(document.body).removeClass(ci),
                t._resetAdjustments(),
                t._resetScrollbar(),
                f(t._element).trigger(si.HIDDEN);
            });
        }),
        ...
        (o._jQueryInterface = function (i, n) {
          return this.each(function () {
            ...
            if (
              (t || ((t = new o(this, e)), f(this).data(ti, t)),
              "string" == typeof i)
            ) {
              if (void 0 === t[i])
                throw new TypeError('No method named "' + i + '"');
          ...
          n.forEach(function (t) {
            !(function (t, e) {
              ...
              if (-1 !== e.indexOf(i))
                return (
                  -1 === _i.indexOf(i) ||
                  Boolean(t.nodeValue.match(wi) || t.nodeValue.match(xi))
                );
              for (
  ...
  var Ti = "tooltip",
    ...
    Ui = (function () {
      ...
      return (
        ...
        (t.toggle = function (t) {
          if (this._isEnabled)
            if (t) {
              ...
              if (f(this.getTipElement()).hasClass(Fi))
        ...
        (t.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            o.setAttribute("id", s),
              ...
              this.setContent(),
              this.config.animation && f(o).addClass(zi);
            var r =
        ...
        (t.hide = function (t) {
          function e() {
            i._hoverState !== Mi && n.parentNode && n.parentNode.removeChild(n),
              i._cleanTipClass(),
        ...
        (t.setContent = function () {
          ...
          this.setElementContent(f(t.querySelectorAll(Hi)), this.getTitle()),
            f(t).removeClass(zi + " " + Fi);
        }),
        ...
        (t._enter = function (t, e) {
          ...
          (e = e || f(t.currentTarget).data(i)) ||
            ...
            f(e.getTipElement()).hasClass(Fi) || e._hoverState === Mi
              ? (e._hoverState = Mi)
        ...
        (t._getConfig = function (t) {
          ...
          return (
            ...
            g.typeCheckConfig(Ti, t, this.constructor.DefaultType),
            t.sanitize &&
        ...
        (n._jQueryInterface = function (i) {
          return this.each(function () {
            ...
            if (
              ...
              (t || ((t = new n(this, e)), f(this).data(Ci, t)),
              "string" == typeof i)
            ) {
              if (void 0 === t[i])
                throw new TypeError('No method named "' + i + '"');
  ...
  (f.fn[Ti] = Ui._jQueryInterface),
    (f.fn[Ti].Constructor = Ui),
    (f.fn[Ti].noConflict = function () {
      ...
      return (
        ...
        (n._jQueryInterface = function (i) {
          return this.each(function () {
            ...
            if (
              (t || !/dispose|hide/.test(i)) &&
              (t || ((t = new n(this, e)), f(this).data(Yi, t)),
              "string" == typeof i)
            ) {
              if (void 0 === t[i])
                throw new TypeError('No method named "' + i + '"');
  ...
  (f.fn[Qi] = rn._jQueryInterface),
    (f.fn[Qi].Constructor = rn),
    (f.fn[Qi].noConflict = function () {
    ...
    kn = (function () {
      function i(t, e) {
        ...
        (this._element = t),
          ...
          f(this._scrollElement).on(pn.SCROLL, function (t) {
            return i._process(t);
          }),
          this.refresh(),
          this._process();
      ...
      return (
        ...
        (t.dispose = function () {
          f.removeData(this._element, ln),
            f(this._scrollElement).off(cn),
            (this._element = null),
        ...
        (t._getConfig = function (t) {
          if (
            ...
            e || ((e = g.getUID(an)), f(t.target).attr("id", e)),
              (t.target = "#" + e);
          }
        ...
        (t._activate = function (e) {
          ...
          i.hasClass(fn)
            ? (i.closest(wn).find(Sn).addClass(gn), i.addClass(gn))
            : (i.addClass(gn),
              i
                .parents(vn)
                .prev(yn + ", " + bn)
                .addClass(gn),
              i.parents(vn).prev(_n).children(yn).addClass(gn)),
            f(this._scrollElement).trigger(pn.ACTIVATE, { relatedTarget: e });
        }),
        (t._clear = function () {
          [].slice
            .call(document.querySelectorAll(this._selector))
  ...
  f(window).on(pn.LOAD_DATA_API, function () {
    ...
    (f.fn[an] = kn._jQueryInterface),
    (f.fn[an].Constructor = kn),
    (f.fn[an].noConflict = function () {
      ...
      return (
        (t.show = function () {
          ...
          if (
            !(
              (this._element.parentNode &&
                this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
                f(this._element).hasClass(Pn)) ||
              f(this._element).hasClass(Dn)
            )
          ) {
            var t,
              n,
              e = f(this._element).closest(zn)[0],
              o = g.getSelectorFromElement(this._element);
            if (e) {
              var s = "UL" === e.nodeName || "OL" === e.nodeName ? Hn : Fn;
              n = (n = f.makeArray(f(e).find(s)))[n.length - 1];
            }
            var r = f.Event(An.HIDE, { relatedTarget: this._element }),
              a = f.Event(An.SHOW, { relatedTarget: n });
            if (
              (n && f(n).trigger(r),
              ...
              var l = function () {
                var t = f.Event(An.HIDDEN, { relatedTarget: i._element }),
                  e = f.Event(An.SHOWN, { relatedTarget: n });
        ...
        (t._transitionComplete = function (t, e, i) {
          ...
          if (
            ...
            g.reflow(t),
            t.classList.contains(Mn) && t.classList.add(Ln),
            t.parentNode && f(t.parentNode).hasClass(On))
          ) {
        ...
        (n._jQueryInterface = function (i) {
          return this.each(function () {
            var t = f(this),
              e = t.data(En);
            if (
              (e || ((e = new n(this)), t.data(En, e)), "string" == typeof i)
            ) {
              if (void 0 === e[i])
                throw new TypeError('No method named "' + i + '"');
              e[i]();
  ...
  f(document).on(An.CLICK_DATA_API, Nn, function (t) {
    ...
    (f.fn.tab = qn._jQueryInterface),
    (f.fn.tab.Constructor = qn),
  ...
  var Bn = "toast",
    ...
    io = (function () {
      ...
      return (
        (t.show = function () {
          var t = this;
          f(this._element).trigger(Xn.SHOW),
            this._config.animation && this._element.classList.add(Vn);
          function e() {
            t._element.classList.remove(Zn),
              t._element.classList.add(Gn),
              f(t._element).trigger(Xn.SHOWN),
        ...
        (t.hide = function (t) {
          ...
          this._element.classList.contains(Gn) &&
            (f(this._element).trigger(Xn.HIDE),
            t
              ? this._close()
        ...
        (t.dispose = function () {
          clearTimeout(this._timeout),
            ...
            f(this._element).off(Xn.CLICK_DISMISS),
            f.removeData(this._element, Un),
            (this._element = null),
            (this._config = null);
        }),
        (t._getConfig = function (t) {
          return (
            ...
            g.typeCheckConfig(Bn, t, this.constructor.DefaultType),
            t
          );
        }),
        (t._setListeners = function () {
        ...
        (n._jQueryInterface = function (i) {
          return this.each(function () {
            ...
            if (
              (e ||
                ((e = new n(this, "object" == typeof i && i)), t.data(Un, e)),
              "string" == typeof i)
            ) {
              if (void 0 === e[i])
                throw new TypeError('No method named "' + i + '"');
  ...
  (f.fn[Bn] = io._jQueryInterface),
    (f.fn[Bn].Constructor = io),
    (f.fn[Bn].noConflict = function () {
      ...
      g.extend(n.prototype, {
        ...
        updateCursor: function (t, e) {
          var i,
            n = this,
            o = n.current,
            s = n.$refs.container.removeClass(
        ...
        trigger: function (t, e) {
          ...
          return (
            s ? n.unshift(s) : (s = o),
            n.unshift(o),
            g.isFunction(s.opts[t]) && (i = s.opts[t].apply(s, n)),
            !1 === i
              ? i
              : void ("afterClose" !== t && o.$refs
                  ? o.$refs.container.trigger(t + ".fb", n)
                  : a.trigger(t + ".fb", n))
          );
        },
    ...
    (i.prototype.destroy = function () {
      ...
      (i.prototype.onSwipe = function (t) {
        ...
        if (!0 !== i)
          "x" == i &&
            ...
            n.requestId && (_(n.requestId), (n.requestId = null)),
      ...
      (i.prototype.limitMovement = function () {
        ...
        return (
          ...
          c < 0 && o < i && (o = i + 1 - Math.pow(i - u - c, 0.8) || 0),
          0 < h && e < s && (s = e - 1 + Math.pow(-e + p + h, 0.8) || 0),
          h < 0 && s < n && (s = n + 1 - Math.pow(n - p - h, 0.8) || 0),
          { top: s, left: o }
        );
      }),
              ...
              t &&
                ...
                (0, n.default)(function () {
                  t.forEach(function (t) {
                    t.target &&
                      t.target.jarallax &&
                      (p || t.target.jarallax.onResize(), (f = !0));
                  });
                });
            }),
          C = 0,
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (i.position = t.image.position),
                    ...
                    t.onResize(),
                    t.onScroll(!0),
                    t.options.automaticResize && T && T.observe(t.$item),
    ...
    s.fn.niceSelect = function (t) {
      ...
      this.hide(),
        ...
        s(document).on("click.nice_select", function (t) {
          0 === s(t.target).closest(".nice-select").length &&
            s(".nice-select").removeClass("open").find(".option");
        }),
        s(document).on(
          "click.nice_select",
        ...
        s(document).on("keydown.nice_select", ".nice-select", function (t) {
          ...
          if (38 == t.keyCode) {
            if (e.hasClass("open")) {
              ...
              0 < o.length &&
                (e.find(".focus").removeClass("focus"), o.addClass("focus"));
            } else e.trigger("click");
            return !1;
          }
  ...
  function a(e) {
    ...
    if (!o.img) {
      (o.img = new Image(e.width, e.height)),
        (o.img.srcset = f.call(e, "data-ofi-srcset") || e.srcset),
        (o.img.src = f.call(e, "data-ofi-src") || e.src),
      ...
      g = {
        init: function (t) {
          ...
          C.liveSelector && (this.selector += "," + C.liveSelector),
            ...
            S(T)
              .unbind("." + k)
              .bind("scroll.mPS2id resize." + k, function () {
                if (m._isDisabled.call(null)) m._removeClasses.call(null);
                else {
                  var o = S("._mPS2id-t");
                  o.each(function (t) {
                    ...
                    m._setClasses.call(null, !1, e, n),
                      t == o.length - 1 && m._extendClasses.call(null);
                  });
                }
              }),
            (n = !0),
        ...
        scrollTo: function (t, e) {
          if (m._isDisabled.call(null)) m._removeClasses.call(null);
            ...
            m._reset.call(null),
              ...
              (h = e.offset),
              (t = -1 !== t.indexOf("#") ? t : "#" + t),
              m._isValid.call(null, t) &&
                m._findTarget.call(null, t) &&
                ((o = "scrollTo"),
                (r = e.clicked) && m._setClasses.call(null, !0),
                m._scrollTo.call(null));
          }
        },
        destroy: function () {
      ...
      m = {
        _isDisabled: function () {
          var t = T,
            e = "inner",
            i =
              C.disablePluginBelow instanceof Array
                ? [C.disablePluginBelow[0] || 0, C.disablePluginBelow[1] || 0]
                : [C.disablePluginBelow || 0, 0];
          return (
            "innerWidth" in T ||
        ...
        _isValid: function (t, e) {
          if (t) {
            ...
            return (
              "#" !== t &&
              -1 !== t.indexOf("#") &&
              ("" === i || decodeURIComponent(i) === decodeURIComponent(n))
            );
          }
        },
        _setup: function () {
          ...
          return S(r).each(function () {
            ...
            if (m._isValid.call(null, e, i)) {
              ...
              var n =
                  -1 !== e.indexOf("#/") ? e.split("#/")[1] : e.split("#")[1],
                o = S(-1 !== n.indexOf("%") ? c.getElementById(n) : "#" + n);
              if (0 < o.length) {
                C.highlightByNextTarget &&
                  o !== l &&
                  (l ? l.data(k, { tn: o }) : o.data(k, { tn: "0" }), (l = o)),
                  o.hasClass("_mPS2id-t") || o.addClass("_mPS2id-t"),
                  o.data(k, { i: a }),
                  t.hasClass("_mPS2id-h") || t.addClass("_mPS2id-h");
                var s = m._findHighlight.call(null, n);
                m._setClasses.call(null, !1, o, s),
                  (f = a),
                  ++a == S(r).length && m._extendClasses.call(null);
              }
            }
          });
        },
        _highlightSelector: function () {
          return C.highlightSelector && "" !== C.highlightSelector
            ? C.highlightSelector
            : i;
        },
        ...
        _setOffset: function () {
          var t, e, i, n;
          switch (
            ((h = h || (C.offset ? C.offset : 0)), d && (h = d), typeof h)
          ) {
            case "object":
            case "string":
              0 <
              (e = [
                (t = [h.y ? h.y : h, h.x ? h.x : h])[0] instanceof jQuery
                  ? t[0]
                  : S(t[0]),
                t[1] instanceof jQuery ? t[1] : S(t[1]),
              ])[0].length
                ? ((i = e[0].height()),
        ...
        _setClasses: function (t, e, i) {
          var n = C.clickedClass,
            ...
            s = C.highlightClass;
          t && n && "" !== n
            ? (S("." + n).removeClass(n), r.addClass(n))
            : e &&
              o &&
              "" !== o &&
              i &&
              s &&
              "" !== s &&
              (m._currentTarget.call(null, e)
                ? (e.addClass(o), i.addClass(s))
                : (!C.keepHighlightUntilNext || 1 < S("." + s).length) &&
                  (e.removeClass(o), i.removeClass(s)));
        },
        _extendClasses: function () {
          var t = C.targetClass,
            ...
            r = e + "-first",
            a = e + "-last";
          S("._mPS2id-t").removeClass(o + " " + s),
            S("._mPS2id-h").removeClass(r + " " + a),
            C.forceSingleHighlight
              ? C.keepHighlightUntilNext && 1 < i.length
                ? (i.slice(0, 1).removeClass(t), n.slice(0, 1).removeClass(e))
                : (i.slice(1).removeClass(t), n.slice(1).removeClass(e))
              : (i.slice(0, 1).addClass(o).end().slice(-1).addClass(s),
                n.slice(0, 1).addClass(r).end().slice(-1).addClass(a));
        },
        _removeClasses: function (t) {
          S("." + C.clickedClass).removeClass(C.clickedClass),
            S("." + C.targetClass).removeClass(
              C.targetClass +
                " " +
                C.targetClass +
                "-first " +
            ...
            S("." + C.highlightClass).removeClass(
              C.highlightClass +
                " " +
                C.highlightClass +
                "-first " +
            ...
            t &&
              (S("._mPS2id-t").removeClass("_mPS2id-t"),
              S("._mPS2id-h").removeClass("_mPS2id-h"));
        },
        _currentTarget: function (t) {
          ...
          if (C.highlightByNextTarget) {
            ...
            if (w) {
              ...
              "vertical" === C.layout
                ? (b = [n.top <= h / 2, x.top > h / 2, 1, 1])
                : "horizontal" === C.layout &&
                  (b = [1, 1, n.left <= d / 2, x.left > d / 2]);
            }
          }
        ...
        _scrollTo: function () {
          (u = m._scrollSpeed.call(null)),
            (a = C.pageEndSmoothScroll ? m._pageEndSmoothScroll.call(null) : a);
          var t = S("html,body"),
            ...
            case "auto":
              if (n != a[0] || o != a[1])
                if (
                  ...
                  t.stop()
                    .animate(
                      { pageYOffset: a[0], pageXOffset: a[1] },
                      {
                        duration: e,
                        easing: i,
                        step: function (t, e) {
                          "pageXOffset" == e.prop
                            ? (s = t)
                            : "pageYOffset" == e.prop && T.scrollTo(s, t);
                        },
                      }
                    )
                    .promise()
                  ...
                  t.stop()
                    .animate({ scrollTop: a[0], scrollLeft: a[1] }, e, i)
                    .promise()
                    .then(function () {
                      m._callbacks.call(null, "onComplete");
                    });
        ...
        _autoScrollSpeed: function () {
          var t = S(T).scrollTop(),
            ...
            n = S(c).width(),
            o = [
              u + (u * Math.floor((Math.abs(a[0] - t) / i) * 100)) / 100,
              u + (u * Math.floor((Math.abs(a[1] - e) / n) * 100)) / 100,
            ];
        ...
        _live: function () {
          t = setTimeout(function () {
            C.live
              ? S(m._highlightSelector()).length !== f && m._setup.call(null)
              : t && clearTimeout(t),
              m._live.call(null);
          }, 1e3);
        },
        _easing: function () {
          ...
          (S.easing.easeInQuad =
            ...
            (S.easing.easeInQuart =
              S.easing.easeInQuart ||
              function (t) {
                return t * t * t * t;
              }),
            (S.easing.easeOutQuart =
              S.easing.easeOutQuart ||
              function (t) {
                return 1 - Math.pow(1 - t, 4);
              }),
            (S.easing.easeInOutQuart =
              S.easing.easeInOutQuart ||
              function (t) {
                return t < 0.5
                  ? 8 * t * t * t * t
            ...
            (S.easing.easeInQuint =
              S.easing.easeInQuint ||
              function (t) {
                return t * t * t * t * t;
              }),
            (S.easing.easeOutQuint =
              S.easing.easeOutQuint ||
              function (t) {
                return 1 - Math.pow(1 - t, 5);
              }),
            (S.easing.easeInOutQuint =
              S.easing.easeInOutQuint ||
              function (t) {
                return t < 0.5
                  ? 16 * t * t * t * t * t
            ...
            (S.easing.easeInBounce =
              S.easing.easeInBounce ||
              function (t) {
                return 1 - e(1 - t);
              }),
            (S.easing.easeOutBounce = S.easing.easeOutBounce || e),
            (S.easing.easeInOutBounce =
              S.easing.easeInOutBounce ||
              function (t) {
                return t < 0.5
                  ? (1 - e(1 - 2 * t)) / 2
    ...
    m._easing.call(),
      (S.fn[e] = function (t) {
        return g[t]
          ...
          : "object" != typeof t && t
          ? void S.error("Method " + t + " does not exist")
  ...
  (function (t) {
    ...
    function n(t, g) {
        ...
        if (
          ...
          if (
            ...
            return (
              ...
              S(),
              k(0, o),
              !n || Z === g.fingers || g.fingers === St || y()
                ? ((tt = D()),
                  2 == Z && (k(1, n[1]), (B = U = O(J[0].start, J[1].start))),
      ...
      function i(t) {
        ...
        if (G !== Et && G !== $t && !T()) {
          ...
          if (
            ...
            2 == Z &&
              (0 == B
                ? (k(1, d[1]), (B = U = O(J[0].start, J[1].start)))
                : (E(d[1]),
                  (U = O(J[0].end, J[1].end)),
                  J[0].end,
                  J[1].end,
            ...
            if (
                  ...
                  if (g.allowPageScroll === ft) t.preventDefault();
                    ...
                    switch (e) {
                      ...
                      case ct:
                        ...
                        break;
                      case ht:
                        ((g.swipeUp && i) || (!i && g.allowPageScroll != xt)) &&
                          t.preventDefault();
                        break;
                      case dt:
                        ((g.swipeDown && i) ||
              ...
              !g.triggerOnTouchEnd && p
                ? (G = m(kt))
                : g.triggerOnTouchLeave && !p && (G = m(Et)),
                (G != $t && G != Et) || v(c, G);
            }
          } else v(c, (G = $t));
          !1 === h && v(c, (G = $t));
      ...
      function n(t) {
        ...
        if (n) {
          if (n.length && !T())
            return (e = i), (it = D()), (nt = e.touches.length + 1), !0;
        ...
        return (
          ...
          c() || !l()
            ? v(i, (G = $t))
            : g.triggerOnTouchEnd || (!1 === g.triggerOnTouchEnd && G === kt)
            ? (!1 !== g.preventDefaultEvents &&
                !1 !== t.cancelable &&
                t.preventDefault(),
              v(i, (G = Et)))
            : !g.triggerOnTouchEnd && b()
            ? a(i, (G = Et), yt)
            : G === kt && v(i, (G = $t)),
          C(!1),
          null
      ...
      function m(t) {
        ...
        return (
          !i || o
            ? (e = $t)
            : !n || t != kt || (g.triggerOnTouchEnd && !g.triggerOnTouchLeave)
            ? !n && t == Et && g.triggerOnTouchLeave && (e = $t)
            : (e = Et),
          e
        );
      }
      function v(t, e) {
        ...
        return (
          ...
          x() && w() && !1 !== i
            ? (i = a(t, e, _t))
            : q > g.longTapThreshold && N < Tt && g.longTap && !1 !== i
            ? (i = a(t, e, bt))
            : (1 !== Z && It) ||
              !(isNaN(N) || N < g.threshold) ||
              !b() ||
              !1 === i ||
              (i = a(t, e, yt)),
          e === $t && o(),
      ...
      function a(t, e, i) {
        ...
        if (i == mt) {
          if (
            (K.trigger("swipeStatus", [e, R || null, N || 0, q || 0, Z, J, W]),
            g.swipeStatus &&
              !1 ===
          ...
          if (e == Et && u()) {
            if (
              (clearTimeout(st),
              clearTimeout(rt),
              K.trigger("swipe", [R, N, q, Z, J, W]),
              g.swipe && !1 === (n = g.swipe.call(K, t, R, N, q, Z, J, W)))
            )
              return !1;
            switch (R) {
              case lt:
                K.trigger("swipeLeft", [R, N, q, Z, J, W]),
                  g.swipeLeft && (n = g.swipeLeft.call(K, t, R, N, q, Z, J, W));
                break;
              case ct:
                K.trigger("swipeRight", [R, N, q, Z, J, W]),
                  g.swipeRight &&
                    (n = g.swipeRight.call(K, t, R, N, q, Z, J, W));
                break;
              case ht:
                K.trigger("swipeUp", [R, N, q, Z, J, W]),
                  g.swipeUp && (n = g.swipeUp.call(K, t, R, N, q, Z, J, W));
                break;
              case dt:
                K.trigger("swipeDown", [R, N, q, Z, J, W]),
                  g.swipeDown && (n = g.swipeDown.call(K, t, R, N, q, Z, J, W));
            }
          }
        }
        if (i == vt) {
          if (
            (K.trigger("pinchStatus", [e, X || null, Y || 0, q || 0, Z, Q, J]),
            g.pinchStatus &&
              !1 ===
          ...
          if (e == Et && d())
            switch (X) {
              case ut:
                K.trigger("pinchIn", [X || null, Y || 0, q || 0, Z, Q, J]),
                  g.pinchIn &&
                    (n = g.pinchIn.call(
                      K,
                      t,
                ...
                break;
              case pt:
                K.trigger("pinchOut", [X || null, Y || 0, q || 0, Z, Q, J]),
                  g.pinchOut &&
                    (n = g.pinchOut.call(
                      K,
                      t,
      ...
      function C(t) {
        K &&
          (!0 === t
            ? (K.bind(j, i), K.bind(z, n), F && K.bind(F, s))
            : (K.unbind(j, i, !1), K.unbind(z, n, !1), F && K.unbind(F, s, !1)),
          K.data(Pt + "_intouch", !0 === t));
      }
      function k(t, e) {
        var i = {
          start: { x: 0, y: 0 },
